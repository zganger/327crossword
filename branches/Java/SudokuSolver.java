...
public class SudokuSolver {
     ...
     * @return true if puzzle is solvable, false if not
    */
    ...
    // computes the 0..80 index of the column encoding the constraint on a and b
	...
	*/
     ...
     *
     * 81 columns are required to encode each of these constraints over
     * the entire puzzle; hence the DLX matrix has 81 * 4 = 324 columns.
     *
     * Each row of the DLX matrix represents the assignment of a
     * digit to a cell; hence there are 9 * 81 = 729 rows.  Each row
     * represents the placement of one digit such that all four constraints
     * are satisfied--each row has exactly four entries.  The overall
     * structure is a matrix of 236,196 cells 98.8% of which contain zero.
    */
